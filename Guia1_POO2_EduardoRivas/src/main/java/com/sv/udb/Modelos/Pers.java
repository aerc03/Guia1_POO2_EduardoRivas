...
public class Pers {
    ...
    public Pers(int codi_pers, String nomb_pers, String apel_pers, Tipo_pers codi_tipo_pers, String gene_pers, String fech_naci_pers, String dui_pers, String nit_pers, String tipo_sang_pers, UbicGeog codi_ubic_geog, String fech_alta, String fech_baja, Blob esta) {
        this.codi_pers = codi_pers;
        this.nomb_pers = nomb_pers;
        this.apel_pers = apel_pers;
        this.codi_tipo_pers = codi_tipo_pers;
